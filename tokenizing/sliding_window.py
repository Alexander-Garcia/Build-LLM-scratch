...
# create some dummy input IDs
input_ids = torch.tensor([2, 3, 5, 1])
vocab_size = 6
output_dim = 3
torch.manual_seed(123)
# instantiate embedding layer
# will be 6 rows and 3 columns
# 1 row for each of the six possible tokens in vocab and 1 column for each of the 3 embedding dimensions
...
# apply embedding to all 4 input IDs
...
data_iter = iter(dataloader)
inputs, targets = next(data_iter)
# token ID tensor is 8x4 dim = 8 samples with 4 tokens each
print("Token IDs:\n", inputs)
print("\nInputs shape:\n", inputs.shape)
